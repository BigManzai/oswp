<?php
/*
Plugin Name: oswp-deleteavatarwidget
Plugin URI:        https://github.com/BigManzai/oswp-deleteavatarwidget
Description: OpenSimulator WordPress Delete Avatar dashboard Widget.
Version:           1.0.18
Author:            Manfred Aabye
Author URI:        http://openmanniland.de
License: GPLv2 or later
*/
add_action('wp_dashboard_setup', array('oswp_deleteavatarwidget','init') );

class oswp_deleteavatarwidget {

    /**
     * Die ID dieses Widgets.
     */
    const wid = 'oswp_deleteavatarwidget';
    ...
    public static function init() {
        ...
        self::update_oswp_deleteavatarwidget_options(
        ...
        wp_add_dashboard_widget(
            ...
            __( 'oswp-deleteavatarwidget', 'nouveau' ),				// Sichtbarer Name für das Widget
            array('oswp_deleteavatarwidget','widget'),      		// Rückruf für den Hauptinhalt des Widgets
            array('oswp_deleteavatarwidget','config')       		// Optionaler Rückruf für Widget-Konfigurationsinhalte
        );
    }
...
/*     public static function config() {
    ...
    public static function get_dashboard_widget_options( $widget_id='' )
    {
        ...
        $opts = get_option( 'oswp_deleteavatarwidget_options' );
      ...
      * @return string
      */
    public static function get_oswp_deleteavatarwidget_option( $widget_id, $option, $default=NULL ) {

        $opts = self::get_oswp_deleteavatarwidget_options($widget_id);
      ...
      */
    public static function update_oswp_deleteavatarwidget_options( $widget_id , $args=array(), $add_only=false )
    {
        // ALLE Dashboard Widget Optionen aus der Datenbank abrufen ...
        $opts = get_option( 'oswp_deleteavatarwidget_options' );
        ...
        return update_option('oswp_deleteavatarwidget_options', $opts);
    }
